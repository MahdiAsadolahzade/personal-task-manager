    ...
    >
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="space-y-4 text-center md:text-left">
          ...
          >
            Hello! I'm <span className="font-semibold text-primary">Mahdi Asadolahzade</span>, 
            the developer behind this project. I build interactive web applications with modern 
      ...
      >
        ...
        <p className="text-foreground/80">
          This task management application was built with Next.js, TypeScript, Tailwind CSS, 
          and Framer Motion. It features responsive design, smooth animations, and efficient 
          state management.
        </p>
      </motion.div>
    </motion.div>
