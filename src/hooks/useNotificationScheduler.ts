...
export const useNotificationScheduler = () => {
        ...
        try {
            ...
            if ('sync' in registration) {
                ...
                try {
                    ...
                    scheduleWithTimeout(notif, new Date(notif.scheduledTime!).getTime() - Date.now());
                }
            } else {
    ...
    async function storeNotificationForSync(notif: TNotification) {
        // Implement storing notification in IndexedDB for service worker access
        // This should match what your service worker expects
